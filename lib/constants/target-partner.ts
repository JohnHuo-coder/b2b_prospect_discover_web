export const TARGET_PARTNER_INDUSTRY_HINT =
...
export const TARGET_PARTNER_SEARCH_LOCATION_PLACEHOLDER = "e.g. Chicago";

export const TARGET_PARTNER_SEARCH_LOCATION_HELP =
  "For locations outside the United States, include the country. For U.S. locations, the country is optional.";
